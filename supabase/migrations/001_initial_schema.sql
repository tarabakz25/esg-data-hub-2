...
INSERT INTO data_sources (id, name, type, department, contact_email) VALUES
('11111111-1111-1111-1111-111111111111', '人事部', 'csv', 'Human Resources', 'hr@company.com'),
('22222222-2222-2222-2222-222222222222', '財務部', 'csv', 'Finance', 'finance@company.com'),
('33333333-3333-3333-3333-333333333333', '事業部', 'csv', 'Operations', 'ops@company.com'),
('44444444-4444-4444-4444-444444444444', 'サステナビリティ部', 'csv', 'Sustainability', 'sustainability@company.com'),
('55555555-5555-5555-5555-555555555555', '外部API', 'api', 'External', 'external@company.com');

-- Insert sample KPIs
INSERT INTO kpis (name, description, unit, issb_tag, category, required) VALUES
('温室効果ガス排出量（スコープ1）', '事業活動による直接的な温室効果ガス排出量', 'tCO2e', 'E1-1', 'environmental', true),
('温室効果ガス排出量（スコープ2）', '購入した電力による間接的な温室効果ガス排出量', 'tCO2e', 'E1-2', 'environmental', true),
('水使用量', '事業活動における年間水使用量', 'm³', 'E3-1', 'environmental', false),
('廃棄物発生量', '事業活動における年間廃棄物発生量', 'ton', 'E5-1', 'environmental', false),
('従業員数', '全従業員数（正社員・契約社員含む）', '人', 'S1-1', 'social', true),
('女性管理職比率', '管理職における女性の割合', '%', 'S1-2', 'social', true),
('労働災害件数', '年間の労働災害発生件数', '件', 'S1-3', 'social', false),
('取締役会の多様性', '取締役会における女性・外国人・若手の比率', '%', 'G1-1', 'governance', true);
